...
int main() {
	const char test_name[] = "equality_true/";
	...
	for(int i = 0; i < random_test_size; i = i + 1) {
		...
		std::string emplace_string1 = stringify_set(set, true);
		std::string emplace_string2 = stringify_set(set, true);
		...
		bool user_result = Equality(user_set1, user_set2);
